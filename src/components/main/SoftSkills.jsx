    ...
    <ul className="pl-4" style={{ color: "white" }}>
      <li>
        ...
        <p className={"body"}>
          ...
          <span className="green-text">Problem Solving, </span>I constantly test
          myself against problems in{" "}
      ...
      <li>
        ...
        <p className={"body"}>
          ...
          things,<span className="green-text"> curiosity</span> is one of my
          strengths.
        </p>
      </li>
      <li>
        ...
        <p className={"body"}>
          ...
          myself someone quite a <span className="green-text">planner</span>.
        </p>
      </li>
      <li>
      ...
      <li>
        ...
        <p className={"body"}>
          ...
          <span className="green-text"> communicate</span> doubts or be sincere
          when you don't know about some topic.
        </p>
      </li>
    </ul>
  );
